...
from v3.utils.config import TIMEZONE
...
class GoogleCalendarService:
    ...
    def __init__(self):
        ...
        # Use absolute paths for credentials and token
    ...
    def get_events(self, filters: Dict[str, Any] = None) -> List[CalendarEvent]:
        ...
        try:
            ...
            from v3.utils.time_parser import get_date_range
    ...
    def _parse_time_string(self, time_str: str) -> datetime:
        ...
        from v3.utils.time_parser import parse_datetime
