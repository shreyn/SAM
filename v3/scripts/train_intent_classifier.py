...
# CONFIGURATION
# -----------------------------
DATA_PATH = 'SAM classifier training data - Sheet1 (2).csv'  # Path to your labeled CSV
default_model_name = 'all-MiniLM-L6-v2'  # Embedding model
CLASSIFIER_PATH = 'intent_classifier.joblib'  # Where to save the trained classifier
LABEL_ENCODER_PATH = 'intent_label_encoder.joblib'  # Where to save the label encoder
