...
from utils.config import API_URL, MODEL_NAME, MAX_RESPONSE_LENGTH
...
- "Hi there" → greeting|0.8"""
    ...
    def generate_response(self, result: str, max_tokens: int = None) -> str:
        """Generate natural response, with optional max_tokens override."""
        if self.mock_mode:
